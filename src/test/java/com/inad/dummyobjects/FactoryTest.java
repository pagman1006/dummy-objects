...
class FactoryTest {
    ...
    void createObjectTest() {
        final DummyDto dto = Factory.create(DummyDto.class);
    ...
    private static void verifyPrimitives(final DummyDto dto) {
    ...
    private static void verifyWrappersAndString(final DummyDto dto) {
    ...
    private static void verifyDateTimeTypes(final DummyDto dto) {
    ...
    private static void verifyEnum(final DummyDto dto) {
    ...
    private static void verifyNestedObject(final DummyDto dto) {
    ...
    private static void verifyList(final DummyDto dto) {
    ...
    void createListTest() {
        int size = 5;
        final List<DummyDto> list = Factory.create(DummyDto.class, size);
